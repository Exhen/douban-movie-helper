...
if (!document.getElementById("seBwhA") && "页面不存在" !== document.title) {
    ...
    if (location.href.startsWith('https://movie.douban.com/subject/')) {
        $(document).ready(function () {
            ...
            var site_offline, site_online, site_sub, site_pt, update_site_offline_sites, update_site_online_sites, update_site_sub_sites, update_site_pt_sites;
            ...
            update_site_offline_sites = function (title, en, imdb) {
                ...
                if (en) {
                    site_offline_sites = {
                        ...
                        'Bing': 'https://cn.bing.com/search?q=' + title + '+torrent',
                        'Google': 'https://www.google.com.hk/search?q=' + title + '+torrent'
                    };
                } else {
                    site_offline_sites = {
                        '电影首发站': 'http://www.dysfz.cc/key/' + title + '/',
                        '胖鸟电影': 'http://www.pniao.com/Mov/so/' + title,
                        "btso": "https://btso.pw/search/" + title,
                        "嘎嘎影视": "http://www.gagays.xyz/movie/search?req%5Bkw%5D=" + title,
                        '天天看电影': 'http://www.ttkmov.com/index.php?m=vod-search&wd=' + title,
                        ...
                        'movie吧': 'http://www.52movieba.com/search_' + title + '.html',
                        '动漫花园': 'https://share.dmhy.org/topics/list?keyword=' + title,
                        '飘花资源': 'http://so.piaohua.com:8909/plus/search.php?kwtype=0&keyword=' + title,
                        '电影街': 'https://moviejie.com/search/q_' + title,
                        'RARBT': 'http://www.rarbt.com/index.php/search/index.html?search=' + title,
                        'CILI001': 'http://oabt002.com/index?topic_title3=' + title,
                        'ED2000': 'http://zhannei.baidu.com/cse/search?s=5102198518115871963&q=' + title,
                        '百度bt': 'https://www.baidu.com/s?wd=' + title + '+torrent',
                        '百度云': 'https://www.baidu.com/s?wd=' + title + '+云'
                    };
                }
            ...
            update_site_sub_sites = function (title, en) {
                ...
                if (en) {
                    site_offline_sites = {
                        ...
                        'Opensub': 'https://www.opensubtitles.org/en/search2/sublanguageid-all/moviename-' + title
                    };
                } else {
                    site_offline_sites = {
            ...
            update_site_pt_sites = function (imdb, en) {
                var link, link_parsed, name, site_pt_sites;
                if (en) {
                    site_pt_sites = {
                        // global sites
                        'ADC': 'http://asiandvdclub.org/browse.php?descr=1&btnSubmit=Search%21&search=tt' + imdb,
                        'AHD': 'https://awesome-hd.me/torrents.php?searchstr=tt' + imdb,
                        'HDSpace': 'https://hd-space.org/index.php?page=torrents&active=0&options=2&search=' + imdb,
                        'HDBits': 'https://hdbits.org/browse.php?&imdb=' + imdb,
                        'HDT': 'https://hd-torrents.org/torrents.php?active=0&options=2&search=' + imdb,
                        'IPT': 'https://iptorrents.com/t?q=tt' + imdb,
                        'KG': 'https://karagarga.in/browse.php?search_type=imdb&search=' + imdb,
                        'PTP': 'https://passthepopcorn.me/torrents.php?searchstr=tt' + imdb,
                        'SC': 'https://secret-cinema.pw/torrents.php?cataloguenumber=tt' + imdb,
                        'Tik': 'https://www.cinematik.net/browse.php?incldead=1&sort=1&type=asc&srchdtls=1&search=tt ' + imdb,
                        'TorViet': 'http://torviet.com/torrents.php?incldead=0&search_area=4&search=' + imdb,
                        'UHD': 'https://uhdbits.org/torrents.php?searchstr=tt' + imdb,

                        // edu ipv6 sites
                        'BYR': 'https://bt.byr.cn/torrents.php?incldead=0&search_area=4&search=' + imdb,
                        'HUDBT': "https://hudbt.hust.edu.cn/torrents.php?incldead=1&search_area=4&search=" + imdb,
                        'NPUPT': 'https://npupt.com/torrents.php?incldead=1&sort=10&imdb=tt' + imdb,
                        'WHUPT': 'https://pt.whu.edu.cn/torrents.php?incldead=1&search=' + imdb,

                        // chinese sites
                        'CHDBits': 'https://chdbits.co/torrents.php?cat401=1&incldead=0&spstate=0&inclbookmarked=0&search=' + imdb + '&search_area=4&search_mode=0',
                        'CMCT': 'https://hdcmct.org/torrents.php?incldead=1&spstate=0&pick=0&inclbookmarked=0&search=' + imdb + '&search_area=4&search_mode=0',
                        'GZTown': 'https://pt.gztown.net/torrents.php?incldead=1&search_area=4&search=' + imdb,
                        'HD4FANS': 'https://pt.hd4fans.org/torrents.php?incldead=1&spstate=0&inclbookmarked=0&search=' + imdb + '&search_area=4&search_mode=0',
                        'HDChina': 'https://hdchina.org/torrents.php?incldead=1&search_area=4&search_mode=0&search=' + imdb,
                        'HDHome': 'https://hdhome.org/torrents.php?incldead=1&spstate=0&inclbookmarked=0&search=' + imdb + '&search_area=4&search_mode=0',
                        'HDSky': 'https://hdsky.me/torrents.php?incldead=1&spstate=0&inclbookmarked=0&search=' + imdb + '&search_area=4&search_mode=0',
                        'HDTime': 'https://hdtime.org/torrents.php?search=' + imdb_id,
                        'KeepFrds': 'https://pt.keepfrds.com/torrents.php?search=' + imdb_id,
                        'MTeam': 'https://tp.m-team.cc/movie.php?incldead=1&spstate=0&inclbookmarked=0&search=' + imdb + '&search_area=4&search_mode=0',
                        'Ourbits': 'https://ourbits.club/torrents.php?incldead=1&spstate=0&inclbookmarked=0&search=' + imdb + '&search_area=4&search_mode=0',
                        'TLFBits': 'http://pt.eastgame.org/torrents.php?incldead=1&search_area=4&search=' + imdb_id,
                        'U2': 'https://u2.dmhy.org/torrents.php?incldead=1&search_area=4&search=' + imdb_id,
                    ...
                    imdb = encodeURI(imdb);
                    site_pt_sites = {
                        'TTG': 'https://totheglory.im/browse.php?search_field=' + imdb,
                    };
                }
                for (name in site_pt_sites) {
                    link = site_pt_sites[name];
                    link_parsed = parseURL(link);
                    link = $('<a></a>').attr('href', link);
                    link.attr('data-host', link_parsed.host);
                    link.attr('target', '_blank').attr('rel', 'nofollow');
                    link.html(name);
                    link.attr('site', name);
                    $('#content div.site-pt-body ul').append(link);
                }
            ...
            if (flag_ptsite) {
                ...
                site_pt = $(aside_html);
                site_pt.addClass('name-offline');
                site_pt.find('div.c-aside-body').addClass('site-pt-body');
                site_pt.find('h2 i').text('PT资源');
                $('#content div.tags').before(site_pt);

            }


            // config subtitles part
            var flag_subsite = GM_getValue('subsite');
            if (flag_subsite) {
                site_sub = $(aside_html);
                site_sub.addClass('name-offline');
                site_sub.find('div.c-aside-body').addClass('site-sub-body');
                site_sub.find('h2 i').text('字幕资源');
                $('#content div.tags').before(site_sub);
            }

            // config offline part
            var flag_offlinesite = GM_getValue('offlinesite');
            if (flag_offlinesite) {
            ...
            if (imdb.length) {
                ...
                update_site_pt_sites(imdb_id, true);
    ...
    $(document).ready(function () {
        ...
        var cp_box = $('<div class="more-items cp_box"><table cellpadding="0" cellspacing="0"><tbody><tr><td><a>电影黑名单</a><div class="blacklist"></div></td></tr><tr><td><a>原图链接</a><div class="poster"></div></td></tr><tr><td><a>生成信息</a><div class="infogen"></div></td></tr><tr><td><a>PT资源</a><div class="ptsite"></div></td></tr><tr><td><a>离线资源</a><div class="offlinesite"></div></td></tr><tr><td><a>字幕资源</a><div class="subsite"></div></td></tr><tr><td><a>更多评分</a><div class="morerating"></div></td></tr></tbody></table></div>');
        ...
        cp_box.find('div').each(function () {
            ...
            temp.click(function () {
                ...
                console.log(!flag);
                $(this).attr('src', flag ? 'https://raw.githubusercontent.com/Exhen/OurBits-Design/master/ICONS/Cartoon.png' : 'https://raw.githubusercontent.com/Exhen/OurBits-Design/master/ICONS/TV.png');
            })
            ...
            temp.attr('src', flag ? 'https://raw.githubusercontent.com/Exhen/OurBits-Design/master/ICONS/TV.png' : 'https://raw.githubusercontent.com/Exhen/OurBits-Design/master/ICONS/Cartoon.png');
            $(this).append(temp);
        });
