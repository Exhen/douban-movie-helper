    ...
    if (location.href.startsWith('https://movie.douban.com/subject/')) {
        $(document).ready(function () {
            ...
            if (imdb.length) {
                ...
                var cc_num=eval(cclist)[douban_id];
                if(cc_num){
                    if (cc_num < 1 );
                        ...
                        after.insertAdjacentHTML('beforebegin', '<div class="top250"><span class="top250-no">#' + cc_num + '</span><span class="top250-link"><a href="https://www.criterion.com/shop/browse/list?sort=spine_number">Criterion标准收藏</a></span></div> ');
                        [].forEach.call(document.getElementsByClassName('top250'), function (e) {
                            e.style.display = 'inline-block';
                        });
                }
                console.log('cclist',cc_num);
